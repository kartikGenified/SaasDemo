  ...
  const getLocationPermission = async () => {
    ...
    if (Platform.OS === "ios") {
      ...
      LocationServicesDialogBox.checkLocationServicesIsEnabled({
        message:
          "<h2 style='color: #0af13e'>Use Location ?</h2>Genefied wants to change your device settings:<br/><br/>Enable location to use the application.<br/><br/><a href='#'>Learn more</a>",
        ok: "YES",
        cancel: "NO",
        ...
        .catch((error) => {
            Alert.alert(
                ...
                "To scan QR code, Genefied app requires location access, kindly enable GPS access to start scanning",
                [
                  {
                    text: "OK",
                    onPress: () => {

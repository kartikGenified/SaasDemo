  ...
  useEffect(() => {
    ...
    if (registerUserData) {
      ...
      if (registerUserData.success) {
        setSuccess(true)
        setMessage("Registration under process, It will complete in 1-2 days")
...
console.log("responseMap",responseMap)
  ...
  console.log("inserting current lat and long to registration submission", latitude,longitude)
  ...
  return (
    <View
      ...
      <ScrollView style={{ width: '100%', height:'100%' }}>
        ...
        <View style={{ width: width, backgroundColor: "white", alignItems: "center", justifyContent: 'flex-start', paddingTop: 20,paddingBottom:20 }}>
          ...
          {registrationForm &&
            ...
            {registerUserIsLoading && <FastImage
                style={{
                  width: 80,
                  height: 80,
                  alignSelf: "center",
